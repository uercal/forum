        ...
        <template>
            <el-tabs v-model="activeName" type="card" class="">
                ...
                <el-tab-pane label="单位会员" name="company">
                    <el-form ref="form" :model="form" label-width="80px" label-position="left" style="margin-top:30px;">
                        <!--  -->
                        ...
                        <el-row type="flex" class="row-bg">
                            ...
                            <el-col :span="12">
                                <el-form-item label="单位法人：" class="">
                                    <el-input v-model="form.legal_person" placeholder="请填写单位法人"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row type="flex" class="row-bg">
                            <el-col :span="12">
                                <el-form-item label="统一社会信用代码：" label-width="32%">
                                    <el-input v-model="form.company_code" placeholder="请填写单位的统一社会信用代码"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="单位类型：" class="">
                                    <el-input v-model="form.company_type" placeholder="请填写单位类型"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row type="flex" class="row-bg">
                            <el-col :span="24">
                                <el-form-item label="工程服务资格及等级：" label-width="18%">
                                    <el-input v-model="form.server_level" placeholder="如：生态建设和环境工程/公共工程/城市轨道交通/综合经济/电影广播电视"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row type="flex" class="row-bg">
                            <el-col :span="12">
                                <el-form-item label="公司电话：">
                                    <el-input v-model="form.company_tel" placeholder="0898-66666666"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="单位邮箱：" class="">
                                    <el-input type="email" v-model="form.email" placeholder="xx@xx.com"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row type="flex" class="row-bg">
                            <el-col :span="12">
                                <el-form-item label="姓名：">
                                    <el-input v-model="form.manager_name" placeholder="请填写联系人姓名"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="单位职务：" class="">
                                    <el-input type="email" v-model="form.manager_job" placeholder="请填写联系人职务"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row type="flex" class="row-bg">
                            <el-col :span="12">
                                <el-form-item label="联系手机：">
                                    <el-input v-model="form.manager_phone" placeholder="请填写联系人手机"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="微信号：" class="">
                                    <el-input v-model="form.manager_wechat" placeholder="请填写联系人微信号"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <textarea id="container" name="category[detail][content]" type="text/plain" style="height:400px;"></textarea>
                            </el-col>
                        </el-row>
            ...
            methods: {
                ...
                handleAvatarSuccess(res, file) {
                    if (res.code == 1) {
                        ...
                        this.form.company_logo = res.data.file_id;
                        // 
                    } else {
                ...
                handleFileSuccess(res, file) {
                    if (res.code == 1) {
                        // this.imageUrl = URL.createObjectURL(file.raw);                        
                        this.$message.success(res.msg);
                        this.form.license_file = res.data.file_id;
                        // 
                    } else {
                        this.$message.error(res.msg);
                    }
