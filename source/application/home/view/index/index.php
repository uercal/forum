                        ...
                        <div class="eleft-item" onclick="listDetail(<?=$item['id']?>,0)">
                            <div class="eleft-item-title">
                                <div class="eleft-item-author">
                                    <p>作者：<?=empty($item['user']) ? '已删除' : (!empty($item['user']['person']) ? $item['user']['person']['name'] : $item['user']['company']['company_name'])?></p>
                                </div>
                                <p style="font-family: HelveticaNeue;font-size: 14px;color: #666666;letter-spacing: 0.88px;"><?=empty($item['option']) ? '无' : $item['option'][0]?></p>
                            </div>
