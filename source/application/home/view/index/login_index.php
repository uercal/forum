...
<body>
    <div class="am-g">
        <form id="loginForm" class="login-form">
            <fieldset class="myapp-login-form am-form-set">
                <div class="am-form-group am-form-icon">
                    ...
                    <input type="text" class="myapp-login-input-text am-form-field" name="user[user_name]" placeholder="请输入用户名">
                </div>
                <div class="am-form-group am-form-icon">
                    <i class="am-icon-lock"></i>
                    <input type="password" class="myapp-login-input-text am-form-field" name="user[password]" placeholder="请输入密码">
                </div>
                <div class="am-form-group am-form-icon">
                    <i class="am-icon-lock"></i>
                    <input type="text" style="width:55%;" class="myapp-login-input-text am-form-field" max-length="6" name="code" placeholder="请输入验证码">
        ...
        border-bottom-right-radius: 4px;">
            ...
            <button type="button" id="btn-submit" class="myapp-login-form-submit am-btn am-btn-block ">登 陆</button>
        </form>
