        ...
        <div class="detail-container">
            ...
            <div class="act-detail-option">
                <div class="act-detail-item">
                    ...
                    <p>报名时间</p>
                    <p style="color:#4A90E2;"><?=unixtime_to_date('Y-m-d', $detail['sign_begin']) . '至' . unixtime_to_date('Y-m-d', $detail['sign_end'])?></p>
                ...
                <div class="act-detail-item">
                    ...
                    <p>活动时间</p>
                    <p style="color:#F5A623;"><?=unixtime_to_date('Y-m-d', $detail['active_begin']) . '至' . unixtime_to_date('Y-m-d', $detail['active_end'])?></p>
