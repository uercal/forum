 ...
 */
class ArticleEn extends Controller
{
    /**
     * 商品列表(出售中)
     * @return mixed
    ...
    public function add()
    {
        ...
        if ($model->add($this->postData('article'))) {
            return $this->renderSuccess('添加成功', url('article_en/index'));
        }
    ...
    public function parent_add()
    {
        ...
        $model = new ArticleModel;
        if ($model->add($this->postData('article'))) {
            return $this->renderSuccess('添加成功', url('article_en/parent'));
        }
        $error = $model->getError() ?: '添加失败';
        return $this->renderError($error);
    }
    ...
    public function edit($id)
    {
        ...
        if ($model->edit($this->postData('article'))) {
            return $this->renderSuccess('更新成功', url('article_en/index'));
        }
