                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="news[title]" value="" required>
                                </div>
                            </div>
                            ...
                            <div class="detail">
                                ...
                                <div class="am-form-group" id="text">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <!-- 加载编辑器的容器 -->
                                        <script id="container" name="news[content]" type="text/plain" style="width:1000px;height:600px;"></script>
                                    </div>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="news[sort]" value="100" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
