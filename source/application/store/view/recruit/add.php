                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-3 am-u-end">
                                    <input type="text" class="tpl-form-input" name="recruit[job_name]" value="" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end price">
                                    <input type="tel" class="tpl-form-input" name="recruit[job_price]" value="" required>
                                    至
                                    <input type="tel" class="tpl-form-input" name="recruit[_job_price]" value="" required>
                                    <small>元</small>
                                </div>
                            </div>
                            ...
                            <div class="detail">
                                ...
                                <div class="am-form-group" id="text">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <!-- 加载编辑器的容器 -->
                                        <textarea id="container" name="recruit[content]" type="text/plain" style="width:1000px;height:600px;"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-6 am-u-end">
                                    <input type="number" class="tpl-form-input" name="recruit[sort]" value="100" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
