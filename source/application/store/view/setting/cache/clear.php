                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    ...
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="cache[keys][]" value="<?= $key ?>" data-am-ucheck checked required>
                                        <?= $item['name'] ?>
                                    </label>
                                    <?php endforeach; ?>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="cache[isForce]" value="0" checked data-am-ucheck>
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                    ...
                                    <div class="help-block">
                                        <small class="x-color-red">此操作将会强制清空缓存目录，刷新所有数据</small>
                                    </div>
                                </div>
                            </div>
                            <?php else : ?>
