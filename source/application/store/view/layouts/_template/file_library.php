...
<!-- 文件库模板 -->
<script id="tpl-file-attachment" type="text/template">
    <div class="row">
        <div class="file-group">
            <ul class="nav-new">
                <li class="ng-scope {{ is_default ? 'active' : '' }}" data-group-id="-1">
        ...
        <div class="file-list">
            ...
            <div id="file-list-body" class="v-box-body">
                {{ include 'tpl-file-attachment-list' file_list }}
            </div>
            <div class="v-box-footer am-cf"></div>
        </div>
    </div>
...
<!-- 附件列表模板 -->
<script id="tpl-file-attachment-list" type="text/template">
    <ul class="file-list-item">
        {{ include 'tpl-file-list-item-attachment' data }}
    </ul>
    {{ if last_page > 1 }}
...
<script id="tpl-file-list-item" type="text/template">
    {{ each $data }}
    <li class="ng-scope" title="{{ $value.file_name }}" data-file-id="{{ $value.file_id }}" data-file-path="{{ $value.file_path }}">
        <div class="img-cover" style="background-image: url('{{ $value.file_path }}')">
        </div>
...
<!-- 附件列表模板 -->
<script id="tpl-file-list-item-attachment" type="text/template">
    {{ each $data }}
    <li class="ng-scope" title="{{ $value.file_name }}" data-file-id="{{ $value.file_id }}" data-origin-name="{{ $value.origin_name }}" data-file-path="{{ $value.file_path }}">
        <p class="file-name am-text-center am-text-truncate">{{ $value.origin_name }}</p>
        <div class="select-mask">
            <img src="assets/store/img/chose.png">
        </div>
    </li>
