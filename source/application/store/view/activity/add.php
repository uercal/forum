                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="activity[title]" value="" required>
                                </div>
                            </div>
                            ...
                            <div class="detail">
                                ...
                                <div class="am-form-group" id="text">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <!-- 加载编辑器的容器 -->
                                        <script id="container" name="activity[content]" type="text/plain" style="width:1000px;height:600px;"></script>
                                    </div>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-u-sm-6">
                                        <button type="button" class="am-btn am-btn-sm am-btn-secondary am-round am-margin-right" id="sign-start">报名开始</button><span id="sign-startDate"></span>
                                    </div>
                                    <div class="am-u-sm-6">
                                        <button type="button" class="am-btn am-btn-sm am-btn-secondary am-round am-margin-right" id="sign-end">报名结束</button><span id="sign-endDate"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-u-sm-6 am-form-file">
                                        <button type="button" class="am-btn am-btn-sm am-btn-secondary am-round am-margin-right" id="active-start">活动开始</button><span id="active-startDate"></span>
                                    </div>
                                    <div class="am-u-sm-6">
                                        <button type="button" class="am-btn am-btn-sm am-btn-secondary  am-round am-margin-right" id="active-end">活动结束</button><span id="active-endDate"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="activity[sort]" value="100" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
