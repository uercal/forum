        ...
        method = {
            ...
            editor: {
                ...
                addItem: {
                     ...
                     * 添加company
                     */
                    company: function (itemId, $items) {
                        var data = method.diyData.additemData(itemId, 'company'),
                            $html = $(
                                '<div class="item" data-key="' + data.dataId + '">' +
                                '  <div class="container">' +
                                '    <div class="item-form am-form-file">' +
                                ...
                                'data-bind="data.' + data.dataId + '.name" value="' + data.name + '">' +
                                '        </div>' +
                                '</div>' +
                                '<div class="input-group">' +
                                '<label class="am-u-sm-3 am-form-label am-text-xs">跳转地址</label>' +
                                '<div class="am-u-sm-9 am-u-end">' +
                                '<input type="text" name="jumpUrl" data-bind="data.' + data.dataId + '.jumpUrl"' +
                                'value="' + data.jumpUrl + '"' +
                                'placeholder="">   ' +
                                '</div></div></div></div>' +
                                '<i class="iconfont icon-shanchu item-delete"></i>' +
